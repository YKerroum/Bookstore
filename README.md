...
> In this project, I am building a React Application fetching data from API.

**Bookstore** is a website for everyone to manage a list of books. It is a Single Page App (SPA) that allows users to:
